...
public class returnOne {
    ...
    private static boolean findSubsequencesWithSumHelper(int[] arr, int sum, int index, List<Integer> subStack, List<List<Integer>> result) {
        ...
        if(findSubsequencesWithSumHelper(arr, sum, index+1, subStack, result)) {
            return true;
        }
